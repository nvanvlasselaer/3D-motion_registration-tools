...
def write_data_to_csv(dataout, subject_name):
    ...
    header_row = ['Time', 'w1', 'x1', 'y1', 'z1', 'w2', 'x2', 'y2', 'z2', 'x_diff', 'y_diff', 'z_diff', 'loc3_x', 'loc3_y', 'loc3_z']
    ...
    while True:
        ...
        while True:
            try:
                ...
                if station1 and station2 and station3:
